...
export interface PortfolioPosition {
  ...
  /** Текущая рассчитанная относительная доходность позиции. */
  expectedYield: Quotation | undefined
  /** Текущий НКД. */
...
export const PortfolioPosition = {
  ...
  toJSON(message: PortfolioPosition): unknown {
    ...
    message.figi !== undefined && (obj.figi = message.figi)
    message.instrumentType !== undefined && (obj.instrumentType = message.instrumentType)
    message.quantity !== undefined && (obj.quantity = message.quantity ? Quotation.toJSON(message.quantity) : undefined)
...
export const BrokerReport = {
  ...
  toJSON(message: BrokerReport): unknown {
    ...
    message.aciValue !== undefined && (obj.aciValue = message.aciValue ? Quotation.toJSON(message.aciValue) : undefined)
    ...
    message.exchangeClearingCommission !== undefined &&
      (obj.exchangeClearingCommission = message.exchangeClearingCommission
        ...
        : undefined)
    message.repoRate !== undefined && (obj.repoRate = message.repoRate ? Quotation.toJSON(message.repoRate) : undefined)
...
export const DividendsForeignIssuerReport = {
  ...
  toJSON(message: DividendsForeignIssuerReport): unknown {
    ...
    message.quantity !== undefined && (obj.quantity = Math.round(message.quantity))
    message.dividend !== undefined && (obj.dividend = message.dividend ? Quotation.toJSON(message.dividend) : undefined)
