...
export const PostStopOrderRequest = {
  ...
  toJSON(message: PostStopOrderRequest): unknown {
    ...
    message.expirationType !== undefined && (obj.expirationType = stopOrderExpirationTypeToJSON(message.expirationType))
...
export const StopOrder = {
  ...
  fromPartial(object: DeepPartial<StopOrder>): StopOrder {
    ...
    message.stopPrice =
      object.stopPrice !== undefined && object.stopPrice !== null ? MoneyValue.fromPartial(object.stopPrice) : undefined
    return message
  },
}
